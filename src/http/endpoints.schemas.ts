...
export type PostUsersPreRegisterBodyLocale =
  (typeof PostUsersPreRegisterBodyLocale)[keyof typeof PostUsersPreRegisterBodyLocale]

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PostUsersPreRegisterBodyLocale = {
  'en-US': 'en-US',
  'pt-BR': 'pt-BR',
  'es-ES': 'es-ES',
} as const
...
export type PostUsersPreRegisterBody = {
  email: string
  locale: PostUsersPreRegisterBodyLocale
}
...
export type PostUsersBodyLocale =
  (typeof PostUsersBodyLocale)[keyof typeof PostUsersBodyLocale]

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PostUsersBodyLocale = {
  'en-US': 'en-US',
  'pt-BR': 'pt-BR',
  'es-ES': 'es-ES',
} as const
